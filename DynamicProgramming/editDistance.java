...
class editDistance{
	...
	public static void main(String[] args) throws IOException {
		// use ((((((( sc ............... for input
			...
			System.out.println(editDist(str,str1));
...
static int editDist(String str,String str1){

	for(int i=0;i<str.length;i++) arr[i][0]=i;
	for(int i=0;i<str1.length;i++) arr[0][i]=i;	
